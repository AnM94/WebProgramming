...
<html>
	...
	.btn_back {
            ...
            padding: 14px 40px;
            border: none;
            cursor: pointer; /* Μετατρέπει τον cursor σε 'pointer' 'οταν είνα πάνω από το btn 'Login' */
            width: 100%;
            opacity: 0.8; /* Η αδιαφάνεια είναι 0.9 όταν δεν είναι ο δείκτης από πάνω, και γίνεται '1' όταν πηγαίνει από πάνω */    
        }
